...
<body>
    ...
    <div class="d-flex align-items-center">
        <div class="input-group">
            <input type="text" class="form-control" id="searchInput" placeholder="Cari Surat Masuk...">
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="actionMenu">
                                                            <li>
                                                                <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#editUserModal" data-id="<?= $gou->id_masuk ?>"  data-pengirim="<?= $gou->pengirim ?>"  data-perihal="<?= $gou->perihal ?>" data-lampiran="<?= $gou->lampiran ?>" data-nosurat="<?= $gou->nomor_surat ?>">
                                                                    Edit
                                                                </button>
                                                            </li>
                                                            <li><a class="dropdown-item" href="<?= base_url('home/hapussuratm/' . $gou->id_masuk) ?>">Hapus</a></li>

                                                            <?php if (isset($backup_suratm[$gou->id_masuk])) : ?>
                                                                <li>
                                                                    <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#undoEditModal" data-id="<?= $backup_suratm[$gou->id_masuk]->id_masuk ?>"  data-pengirim="<?= $backup_suratm[$gou->id_masuk]->pengirim ?>" data-perihal="<?= $backup_suratm[$gou->id_masuk]->perihal ?>" data-lampiran="<?= $backup_suratm[$gou->id_masuk]->lampiran ?>" data-nosurat="<?= $backup_suratm[$gou->id_masuk]->nomor_surat ?>">
                                                                        Undo Edit
                                                                    </button>
                                                                </li>
                                                            <?php endif; ?>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addUserModalLabel">Tambah Surat Masuk</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="<?= base_url('home/aksi_tambah_suratm') ?>" method="POST" enctype="multipart/form-data">
                            <div class="row">
    ...
    <div class="modal fade" id="editUserModal" tabindex="-1" aria-labelledby="editUserModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editUserModalLabel">Edit Surat Masuk</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="editUserForm" action="<?= base_url('home/aksi_edit_suratm') ?>" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-8 form-group">
                                <input type="text" id="editpengirim" class="form-control" name="pengirim" placeholder="Pengirim">
                            </div>
                            <div class="col-md-4">
                                <label>Perihal</label>
                            </div>
...
<div class="col-md-8 form-group">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="undoEditModalLabel">Undo Edit Surat Masuk</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="undoEditForm" action="<?= base_url('home/aksi_unedit_suratm') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-8 form-group">
                    <input type="text" id="undopengirim" class="form-control disabled-field" name="pengirim" placeholder="Pengirim">
                </div>
...
<script>
    ...
    document.addEventListener('show.bs.modal', function (event) {
        ...
        modal.querySelector('#editpengirim').value = pengirim;
    ...
    if (lampiran) {
        ...
        modal.querySelector('#undopengirim').value = pengirim;
