                                    ...
                                    <td>
                                        <?php 
                                            switch($gou->level){
                                                ...
                                                case 2: echo "Yayasan"; break;
                                                case 3: echo "Kepala Sekolah"; break;
                                                case 4: echo "Wakil Kepala Sekolah"; break;
                                                case 5: echo "Kesiswaan"; break;
                                                case 6: echo "HRD"; break;
...
<div class="col-md-4">
                            ...
                            <div class="col-md-8 form-group">
                                <input type="text" id="editNik" class="form-control" name="nik" placeholder="NIK" >
                            </div>
...
<div class="col-md-4">
                ...
                <div class="col-md-8 form-group">
                    <input type="text" id="undoNik" class="form-control disabled-field" name="nik" placeholder="NIK" >
                </div>
